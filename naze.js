...
const nyoutube = ('© Miko\nYoutube/Sc :\nhttps://youtube.com/c/MikoSAMP')  //ubah di config biar ngk emror
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                naze.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/9GXG8Bh/IMG-20220928-152830.jpg' }, caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Jika ingin berdonasi silahkan scan gambar diatas*\n\n*Atau klik link dibawah ini*\n_https://saweria.co/MikoKrepz \n\n*Atau Transfer via*\n- *Gopay Dana Ovo Qris ShopeePay*\n Ke nomer berikut : 0881027143352\n\n_Terima kasih bagi yang sudah donasi_` }, { quoted: m })
            }
            break
            case 'ipserver': {
                m.reply('IP : play.hyzexnet.my.id\n Port: 19132\n\nMinecraft Version 1.19.30')
            }
            break
            case 'chat': {
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'report': case 'lapor': {
               ...
               let buttons = [{ buttonId: 'hehehe', buttonText: { displayText: '🙏THANKS TELAH LAPOR' }, type: 1 }]
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
           ...
           /**case 'tiktokwm': case 'tiktokwatermark': {
            ...
            case 'tiktokmp3': case 'tiktokaudio': {
                ...
                naze.sendMessage(m.chat, { audio: { url: anu.respon.audio }, mimetype: 'audio/mpeg'}, { quoted: msg })
            }
            break
...
( Q.S ${res.result.data.surah.name.transliteration.id} : ${res.result.data.number.inSurah} )`
		...
		break
		   case 'bass': case 'blown': case 'deep': case 'earrape': case 'fast': case 'fat': case 'nightcore': case 'reverse': case 'robot': case 'slow': case 'smooth': case 'tupai':
                ...
                break
            case 'linkmc': {
                if (!m.quoted) throw 'Ini Yang Kamu Minta\n https://bit.ly/3DJWLqT'
            ...
            break
            case 'topup': {
            	if (!m.quoted) throw 'Berikut Harga Coin\n\nRp.5.000 = 50 COIN\nRp.10,000 = 100 COIN\nRp.20.000 = 200 COIN\nRp.40,000 = 400 COIN\nRp.80.000 = 800 COIN\nRp.100,000 = 1000 COIN\n\nPayment :\nGopay\nPulsa Tsel(Nambah 5K)\nSaweria(All Payment)\n\nMau Beli? Chat!\nhttp://wa.me/+62895402110708'
                let hash = m.quoted.fileSha256.toString('base64')
...
`.trim()
            ...
            break
            case 'vote': {
                if (!m.quoted) throw 'Ini Link Yang Kamu Minta\n\nhttps://minecraftpocket-servers.com/server/119589/vote/\n\n Vote Ya Biar Dapat Money 50.000 + 5 Key Gacha😎\n\nJangan Lupa Vote :D'
                if (!m.quoted.fileSha256) throw 'SHA256 Hash Missing'
                let hash = m.quoted.fileSha256.toString('base64')
...
╰──❍`
                ...
                {title: "HyzexSMP", rowId: `mvoice`, description: `🌿Hyzex Menu`},
